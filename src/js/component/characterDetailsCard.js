    ...
    return (
        <div className="card mb-3 d-flex justify-content-center mx-5 bg-light bg-opacity-75" >
            <div className="row g-0">
                <div className="col-6 h-25 me-0">
                    <img  className= "w-100" src={`https://starwars-visualguide.com/assets/img/characters/${store.characterDetails.characterId}.jpg`} className="img-fluid rounded-start img-fluid" alt="..." />
                </div>
            ...
            <hr className="my-4 bg-secondary fs-1" />
