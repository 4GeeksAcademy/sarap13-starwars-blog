...
export const CharacterDetailsCard = props => {
    ...
    return (
        <div className="card mb-3 mx-auto bg-light bg-opacity-75 mb-5 sizeDetailsCard">
            <div className="row g-0">
                <div className="col-md-4">
                    <img className="resize-card-details-character-img img-fluid" src={`https://starwars-visualguide.com/assets/img/characters/${store.characterDetails.characterId}.jpg`} alt="..." onError={(e) => e.target.src = "https://static.wikia.nocookie.net/esstarwars/images/b/b0/Tatooine_TPM.png/revision/latest?cb=20131214162357"} />
                </div>
